...
export const paymentData = [
  {
    ...
    status: 'Successful',
    reference: nanoid(),
    amountInNaira: '₦700.00',
    amountInUSD: '$4.00',
    paymentMethod: 'BANK_TRANSFER',
    merchant: 'Makecards Payment',
    currency: 'Naira',
    timeStamp: '03/12/2023 05:32 PM',
    logo: <IoIosArrowForward className="text-lg" />,
  },
  {
    id: 2,
    paymentType: 'credit',
